...
| `Chapter2/chapter2.tex` | Cơ sở lý thuyết: U-Net, Attention, SAM, GradCAM |
| `Chapter3/chapter3.tex` | Phương pháp đề xuất: PGA-UNet, PSG, CAD, IPR, MobileNetV4 |
...
| `PGA_GradCAM_IPR.ipynb` | GradCAM rescue + IPR convergence: 174/174=100% phát hiện prompt lỗi |
...
| `PGA_Ablation.ipynb` | IPR convergence (k=0→3) + ablation prompt type (inference-based) |
...
| `pga-gradcam-ipr.ipynb` | GradCAM+IPR: 174/174=100%, Dice k=2: 0.8523 |
...
| `PGA_Ablation.ipynb` | Ablation IPR k=0..3 + prompt type (inference-based) |
