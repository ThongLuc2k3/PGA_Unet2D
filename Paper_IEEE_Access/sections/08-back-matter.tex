...
BTXRD and FracAtlas are public datasets cited in this article. The manuscript reports experiments on image-level train/validation/test splits derived from those datasets. Code and split details are released at \url{https://github.com/ThongLuc2k3/PGA_Unet2D}.
