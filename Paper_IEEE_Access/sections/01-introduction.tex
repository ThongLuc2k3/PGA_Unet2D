...
\item We characterize the effects of the conditioning components, the observed response to a predefined prompt displacement, variability across four repeated image-level splits and four training seeds for PGA-UNet, and computational cost in the tested environment.
\end{itemize}
