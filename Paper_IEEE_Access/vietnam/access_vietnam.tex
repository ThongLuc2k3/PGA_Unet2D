...
Lọc bằng MedSigLIP hạ tỉ lệ dương giả cấp hộp trên các hộp giữ lại này từ 61,96\% xuống 44,62\%, mức giảm tuyệt đối 17,33 điểm phần trăm (khoảng tin cậy bootstrap theo cụm bắt cặp $95\%$ $[16,68; 17,98]$; Bảng~\ref{tab:medsiglip-gate}). Trên chính các hộp tổn thương thuộc tập test BTXRD của bài (232 hộp từ 187 ảnh, dựng theo đúng quy tắc hộp bao phủ dùng xuyên suốt bài), bộ lọc giữ lại 96,12\% số hộp dương (khoảng tin cậy bootstrap theo cụm $95\%$ $[93,42; 98,30]$). Tỉ lệ dương giả cấp ảnh, tức tỉ lệ ảnh lành còn ít nhất một hộp dương giả sống sót trong 50 hộp lấy mẫu, gần như không đổi, từ 100\% xuống 99,93\%: gần như mọi ảnh lành vẫn còn ít nhất một hộp qua mặt được hệ thống đã lọc. Chúng tôi không báo cáo Dice hậu-lọc hay độ đo chất lượng phân đoạn nào khác ở đây. Kết quả này mang tính thăm dò và bổ sung, không phải đóng góp cốt lõi của bài: một bộ lọc hậu kiểm ngoài có thể giảm phản hồi dương giả cấp hộp trong khi vẫn giữ được phần lớn hộp dương, nhưng chưa giải quyết được việc phát hiện dương giả cấp ảnh; phát triển một bộ lọc nhẹ, chuyên dụng, được hiệu chỉnh (calibration) tốt hơn là hướng phát triển tiếp theo (Mục~\ref{sec:discussion}).

\begin{table}[H]
\caption{Bộ lọc hậu kiểm zero-shot MedSigLIP trên ảnh lành BTXRD (tập test giữ lại, 1.469 ảnh, 50 hộp/ảnh, 73.450 hộp). Tỉ lệ giữ lại hộp dương được đo riêng trên các hộp tổn thương thuộc tập test BTXRD của bài (232 hộp, 187 ảnh). Mang tính thăm dò, không phải đóng góp cốt lõi; không có Dice hậu-lọc.}
...
\begin{tabular}{lcc}
\toprule
Đại lượng & Trước lọc & Sau lọc \\
\midrule
FPR cấp hộp (73.450 hộp) & 61,96\% & 44,62\% \\
FPR cấp ảnh (1.469 ảnh) & 100\% & 99,93\% \\
Tỉ lệ giữ lại hộp dương (232 hộp) & 100,00\% & 96,12\% \\
\bottomrule
\end{tabular}
}
\end{table}
