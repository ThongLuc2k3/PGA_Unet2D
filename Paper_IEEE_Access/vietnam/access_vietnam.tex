...
Với chỉ hai seed đã hoàn tất, các độ lệch chuẩn này chưa đủ để phản ánh mức biến thiên seed-với-seed thật sự và không nên đọc như một ước lượng ổn định; chúng chỉ mô tả đúng hai lượt chạy đã quan sát được. Đọc như một so sánh hai điểm, không phải một phân bố: Dice của seed mới hoàn tất thấp hơn khoảng 0,02 so với seed gốc trên BTXRD ở cả hai điều kiện prompt, trong khi trên FracAtlas hai seed chênh nhau trong vòng 0,002 Dice. Precision chênh 0,024 đến 0,034 giữa hai seed trên BTXRD, nhiều hơn mức chênh 0,000 đến 0,002 của Recall ở đó, và nhiều hơn cả hai độ đo này trên FracAtlas (0,007 đến 0,011). HD95 chênh khoảng 1 đến 2 pixel ở BTXRD bao phủ và khoảng 1 pixel ở FracAtlas lệch tâm, dưới 1 pixel ở hai dòng còn lại. Liệu khuôn mẫu này, BTXRD nhạy hơn, có giữ vững hay không thì phải chờ hai seed còn lại; hiện tại chưa có gì ủng hộ một tuyên bố tổng quát về việc bộ dữ liệu hay độ đo nào nhạy hơn với seed huấn luyện.
