...
\begin{enumerate}
    ...
    \end{itemize}
    Hai thành phần phối hợp để mô hình thực sự \textit{sử dụng} câu nhắc xuyên suốt quá trình trích xuất và tái tạo đặc trưng; hiệu quả của biểu diễn heatmap cùng đóng góp riêng của PSG, CAD được kiểm chứng qua nghiên cứu loại bỏ thành phần và so sánh với U-Net, SAM-Med2D trên cả BTXRD và FracAtlas (chi tiết tại Chương~\ref{Chapter4}).
