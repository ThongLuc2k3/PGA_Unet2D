...
\begin{itemize}
    \item Sai số tích lũy luồng xử lý hai giai đoạn: Gatekeeper và PGA-UNet là hai module độc lập nên sai số phân lớp lan truyền sang phân đoạn, kéo hiệu năng đầu cuối xuống đáng kể so với PGA-UNet đơn lẻ (Mục~\ref{sec:ket_luan}), hạn chế cố hữu của kiến trúc hai giai đoạn. Con số này đo kịch bản thận trọng nhất chưa qua xác nhận bác sĩ; trong thiết kế triage mềm thực tế (Mục~\ref{sec:tong_the}, Chương~\ref{Chapter3}), rủi ro này được giảm nhẹ nhưng chưa được đánh giá đầy đủ.
