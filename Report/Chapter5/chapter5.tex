...
Kết quả trên BTXRD và FracAtlas cho thấy PGA-UNet cải thiện rõ rệt hiệu năng phân đoạn so với U-Net, Attention U-Net và SAM-Med2D trong phạm vi các cấu hình được đánh giá. Mô hình duy trì kết quả ổn định hơn khi câu nhắc bị lệch tâm, đồng thời đạt hiệu quả rõ rệt trên các trường hợp khó, tổn thương nhỏ hoặc có ranh giới không rõ. Nghiên cứu loại bỏ thành phần cho thấy hiệu quả của mô hình đến từ sự phối hợp giữa PSG, CAD và bản đồ nhiệt Gaussian, trong đó CAD có vai trò nổi bật đối với tính bền bỉ trước sai lệch câu nhắc.
...
\begin{itemize}
    ...
    \item \textbf{Cải thiện bước sàng lọc:}
    Gatekeeper có thể được cải tiến bằng phương pháp cân bằng lớp, điều chỉnh ngưỡng theo mục tiêu Sensitivity, học tập trung vào vùng tổn thương nhỏ hoặc hiệu chỉnh xác suất dự đoán. Tuy nhiên, module này vẫn nên được duy trì như công cụ hỗ trợ thay vì thay thế quyết định của người dùng chuyên môn.
\end{itemize}
