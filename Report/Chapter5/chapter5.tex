...
Khóa luận cũng bổ sung phép đo hiệu quả tính toán trong cùng môi trường thực nghiệm. Ở độ phân giải $256\times256$, PGA-UNet nhỏ hơn SAM-Med2D khoảng 92 lần về số tham số, 11,9 lần về FLOPs và có độ trễ suy luận thấp hơn rõ rệt trên cả GPU lẫn CPU. Kết quả này củng cố luận điểm rằng PGA-UNet không chỉ cải thiện về độ chính xác trong thiết lập đã khảo sát mà còn thuận lợi hơn cho triển khai trên phần cứng hạn chế.
