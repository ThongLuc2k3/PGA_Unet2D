...
Để giữ văn phong tiếng Việt nhất quán, thân bài khóa luận hạn chế tối đa việc chen tiếng Anh vào câu văn: các thuật ngữ chuyên ngành chung (không phải tên riêng mô hình/kiến trúc, không phải ký hiệu đo lường chuẩn quốc tế) đều được dịch sang tiếng Việt và dùng thống nhất xuyên suốt. Bảng dưới đây liệt kê thuật ngữ tiếng Việt đã dùng kèm thuật ngữ gốc tiếng Anh tương ứng, để đối chiếu khi cần.

Riêng tên mô hình/kiến trúc riêng (U-Net, PGA-UNet, SAM-Med2D, EfficientNet\_B3, ViT-B, Attention Gate...) và ký hiệu đo lường chuẩn quốc tế (Dice, IoU, HD95, CBL, AUC-ROC, Precision, Recall, F1...) được giữ nguyên dạng gốc, không dịch, vì đây là tên riêng/ký hiệu chuẩn hóa quốc tế; xem giải thích tại Phụ lục~\nameref{danhmuctuvietat}.
