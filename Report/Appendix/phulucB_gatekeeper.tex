...
Phụ lục này trình bày chi tiết thực nghiệm mở rộng đã được tóm tắt ở Mục~\ref{sec:product_overview}, Chương~\ref{Chapter4}. Nội dung chính là khảo sát mô-đun sàng lọc Gatekeeper (EfficientNet-B3~\cite{tan2019efficientnet}) khi được đặt trước PGA-UNet trong một luồng xử lý gồm cả ảnh bình thường lẫn ảnh bệnh lý.

PGA-UNet vốn được thiết kế cho bài toán phân đoạn khi người dùng đã chỉ ra vùng nghi ngờ bằng hộp giới hạn. Để hình dung rõ hơn cách mô hình này có thể đặt vào một quy trình thực tế hơn, khóa luận bổ sung Gatekeeper để làm bước sàng lọc ban đầu. Mô-đun này có nhiệm vụ phân loại ảnh thành bình thường hoặc nghi ngờ có bất thường trước khi người dùng xác nhận và chuyển sang bước phân đoạn.

Cần nhắc lại rằng Gatekeeper chỉ là thành phần hỗ trợ thêm, không phải đóng góp kiến trúc chính của khóa luận. Phụ lục này chỉ xem ảnh hưởng của bước sàng lọc đối với luồng phân đoạn, chứ không đánh giá một hệ thống chẩn đoán tự động hoàn chỉnh.
% ------------------------------------------------------------
...
Gatekeeper đạt AUC-ROC 0,9421 và Accuracy 87,73\%, tức là mô hình phân biệt ảnh bệnh lý và ảnh bình thường trên BTXRD khá tốt. Ở ngưỡng 0,5, mô hình phát hiện đúng 167/187 ảnh bệnh lý, tương ứng Sensitivity 89,30\%, và đồng thời phân loại đúng 162/188 ảnh bình thường, tương ứng Specificity 86,17\%. Dù vậy, vẫn còn 20 ảnh bệnh lý bị bỏ sót. Vì vậy, kết quả này chưa đủ để dùng Gatekeeper như một bước loại ảnh âm tính hoàn toàn tự động.
...
Kết quả cho thấy hiệu năng toàn luồng phụ thuộc nhiều vào bước sàng lọc. Dice giảm từ 0,8626 trên các ảnh được chuyển đúng xuống còn 0,6763 khi tính cả lỗi FP và FN. Trong đó, trường hợp đáng ngại nhất vẫn là FN vì ảnh bệnh lý bị dừng lại trước khi đến PGA-UNet.
...
Gatekeeper đạt Accuracy 88,26\% và AUC-ROC 0,9132 trên FracAtlas, tức là nhìn chung vẫn phân biệt được ảnh gãy xương và ảnh bình thường khá tốt. Tuy nhiên, tại ngưỡng 0,5, mô hình chỉ phát hiện đúng 51/72 ảnh bệnh lý, tương ứng Sensitivity 70,83\%, trong khi có tới 21 ảnh bị bỏ sót. Ngược lại, 310/337 ảnh bình thường được phân loại đúng, tương ứng Specificity 91,99\%.

So với BTXRD, Gatekeeper trên FracAtlas có Sensitivity thấp hơn rõ rệt nhưng Specificity lại cao hơn. Có thể thấy mô hình có xu hướng nghiêng về lớp bình thường hơn trên bộ dữ liệu mất cân bằng này, đồng thời cũng gặp khó hơn khi phải nhận diện các đường gãy nhỏ và mảnh từ toàn bộ ảnh.
...
Dice toàn luồng trên FracAtlas chỉ đạt 0,4230, thấp hơn hẳn so với mức 0,6763 trên BTXRD. Lý do chính là Gatekeeper bỏ sót 21/72 ảnh bệnh lý, tương ứng 29,17\%, cao hơn đáng kể so với BTXRD. Trong khi đó, PGA-UNet vẫn đạt Dice 0,8211 trên các ảnh được chuyển đúng, tức là bản thân mô hình phân đoạn vẫn hoạt động tốt nếu ảnh đi đúng luồng.
...
\noindent\textbf{Kết luận.}
Kết quả trên FracAtlas tiếp tục cho thấy Gatekeeper có thể hữu ích ở vai trò hỗ trợ sàng lọc, nhưng chưa đủ tin cậy để tự động quyết định ảnh nào được đưa sang PGA-UNet. Tác động của lỗi sàng lọc ở đây thể hiện rõ do Sensitivity thấp và dữ liệu mất cân bằng. Vì vậy, trong luồng đề xuất, Gatekeeper chỉ nên đóng vai trò gợi ý ưu tiên; người dùng chuyên môn vẫn cần xác nhận và cung cấp hộp giới hạn trước khi phân đoạn.
