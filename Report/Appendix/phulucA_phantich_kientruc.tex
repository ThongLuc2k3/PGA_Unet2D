...
Phụ lục này trình bày đầy đủ các thực nghiệm bổ sung đã được tóm tắt ngắn ở Chương~\ref{Chapter4}. Nội dung gồm bốn phần chính: đo hiệu quả tính toán của PGA-UNet và SAM-Med2D (Mục~\ref{sec:appendix_efficiency}); nghiên cứu loại bỏ thành phần để so sánh các cấu hình PSG/CAD; đánh giá chéo 4-fold để xem độ ổn định; và phân tích theo đặc tính tổn thương trên BTXRD (Mục~\ref{subsec:arch_btxrd}) và FracAtlas (Mục~\ref{subsec:arch_fracatlas}). Cuối phụ lục có một phần tổng hợp chung để rút ra kết luận trên cả hai bộ dữ liệu (Mục~\ref{subsec:conclusion_arch}). Phụ lục được tách riêng như vậy để phần thân bài đỡ nặng số liệu hơn và người đọc cũng dễ theo dõi từng nhóm thí nghiệm hơn.
...
Mục này lưu lại đầy đủ số liệu của phần đo hiệu quả tính toán đã được tóm tắt ở Chương~\ref{Chapter4}. Các phép đo được thực hiện trong cùng môi trường chạy, với cùng thiết bị và cùng cách đo cho từng mô hình. Những chỉ số được ghi nhận gồm số tham số, số tham số có thể huấn luyện, FLOPs, dung lượng checkpoint, bộ nhớ GPU đỉnh và độ trễ suy luận trung bình trên GPU và CPU. PGA-UNet được đo ở hai cấu hình $256\times256$ và $512\times512$, còn SAM-Med2D được đo ở $256\times256$ để tiện đối sánh trực tiếp. Các con số trong mục này chỉ nên hiểu là để so sánh tương đối trong cùng môi trường thực nghiệm.
...
Trên BTXRD, PGA-UNet được phân tích theo ba hướng là đóng góp của từng thành phần kiến trúc, độ ổn định giữa các cách chia dữ liệu và hiệu năng theo đặc tính tổn thương. Trong từng nhóm thí nghiệm, các cấu hình đều được đánh giá trên cùng dữ liệu, cùng kịch bản câu nhắc và cùng cách tính chỉ số ở cấp độ ảnh.
...
Nhìn riêng thì PSG chưa đủ để tạo ra cải thiện rõ rệt ở đầu ra phân đoạn. Vai trò chính của PSG không phải là thay thế quá trình tái tạo mặt nạ, mà là đưa tín hiệu không gian của câu nhắc vào quá trình mã hóa đặc trưng. Phần lợi của tín hiệu này chỉ lộ ra rõ hơn khi nhánh giải mã tiếp tục khai thác nó thông qua CAD trên các kết nối tắt.
...
Vai trò của việc điều kiện hóa chú ý thể hiện rõ hơn khi so sánh CAD với cổng chú ý nguyên bản. Không có PSG, U-Net+CAD cao hơn U-Net+Cổng chú ý nguyên bản 0,0123 ở Bao trọn, 0,0092 ở Lệch tâm và 0,0099 ở Hỗn hợp. Khi có PSG, PGA-UNet cao hơn U-Net+PSG+Cổng chú ý nguyên bản 0,1064 ở Lệch tâm và 0,0387 ở Hỗn hợp, mặc dù thấp hơn 0,0073 ở Bao trọn. Nói cách khác, lợi ích chính không đến từ việc bổ sung một cổng chú ý bất kỳ, mà từ việc điều kiện hóa quá trình chú ý bằng đặc trưng câu nhắc thông qua CAD.
...
PGA-UNet không đạt Dice cao nhất trong kịch bản Bao trọn: U-Net+CAD đạt 0,8861, trong khi PGA-UNet đạt 0,8607. Ngược lại, PGA-UNet đạt kết quả cao nhất trong hai kịch bản, gồm 0,8423 ở Lệch tâm và 0,8560 ở Hỗn hợp. So với U-Net+Concat, mức cải thiện tương ứng là 0,1059 và 0,0344.

Đóng góp chính của PGA-UNet không nằm ở chỗ đẩy hiệu năng lên cao nhất khi câu nhắc hoàn toàn lý tưởng, mà ở khả năng giữ kết quả đỡ rơi hơn khi câu nhắc không chính xác tuyệt đối. PSG riêng lẻ giúp đưa thông tin không gian vào bộ mã hóa nhưng chưa tạo ra cải thiện rõ rệt; CAD cho phép cơ chế chú ý trên các kết nối tắt khai thác trực tiếp đặc trưng câu nhắc; còn bản đồ nhiệt Gaussian làm tăng độ ổn định trước sai lệch vị trí. Ba phần này đi cùng nhau mới tạo ra ưu thế của PGA-UNet trong các kịch bản gần với sai số thao tác có thể xuất hiện khi người dùng cung cấp hộp giới hạn.
...
Dice thay đổi không nhiều giữa bốn phân vùng. Độ lệch chuẩn lần lượt là $0{,}0087$ ở kịch bản Bao trọn, $0{,}0119$ ở Lệch tâm và $0{,}0094$ ở Hỗn hợp. Trong phạm vi bốn cách chia dữ liệu này, có thể xem PGA-UNet là ổn định; trong đó kịch bản Lệch tâm dao động nhiều hơn một chút.
...
Giá trị Dice trung bình của đánh giá chéo khá gần với kết quả trên tập kiểm thử chính. Ví dụ, Dice ở kịch bản Bao trọn đạt $0{,}8629$ qua bốn phân vùng, so với $0{,}8607$ trên tập kiểm thử độc lập. Nói cách khác, kết quả không thay đổi nhiều theo cách chia dữ liệu đã khảo sát, nhưng dĩ nhiên không thay cho tập kiểm thử giữ lại độc lập.
...
Ở nhóm U-Net hoạt động kém, Dice của U-Net chỉ đạt 0,0211, trong khi PGA-UNet đạt 0,8261. Recall tăng từ 0,1063 lên 0,8429 và HD95 giảm từ 284,72 xuống 7,75 điểm ảnh. Tức là PGA-UNet vẫn định vị và phân đoạn được tổn thương trên nhiều ảnh mà U-Net gần như bỏ trắng.
...
Khi kiểm soát độ phân giải ở $256\times256$, PGA-UNet vẫn cao hơn SAM-Med2D trên cả ba nhóm, đặc biệt ở Tổn thương nhỏ và Biên mờ. Còn khi chỉ thay đổi độ phân giải của PGA-UNet, mức cải thiện lớn nhất vẫn rơi vào nhóm Tổn thương nhỏ. Ghép hai phần này lại thì có thể hiểu rằng lợi thế của PGA-UNet trên nhóm này không chỉ đến từ độ phân giải $512\times512$, dù đúng là độ phân giải cao vẫn mang lại thêm cải thiện.
% ------------------------------------------------------------
...
Trên FracAtlas, U-Net và Attention U-Net không sử dụng câu nhắc lần lượt đạt Dice 0,3831 và 0,2467. Trong khi đó, cấu hình nối kênh đơn giản U-Net+Concat đạt 0,8131 ở kịch bản Bao trọn. Nói đơn giản, thông tin vị trí từ câu nhắc đóng vai trò khá quan trọng khi phân đoạn đường gãy xương.
...
Tuy nhiên, U-Net+PSG vẫn thấp hơn PGA-UNet 0,1090 ở Lệch tâm và 0,0429 ở Hỗn hợp. Nói đơn giản thì PSG giúp cải thiện đặc trưng mã hóa, nhưng như vậy vẫn chưa đủ nếu các kết nối tắt của nhánh giải mã không tiếp tục dùng thông tin câu nhắc.
...
So với cổng chú ý nguyên bản có PSG, PGA-UNet sử dụng CAD thấp hơn 0,0182 ở Bao trọn nhưng cao hơn 0,0923 ở Lệch tâm và 0,0291 ở Hỗn hợp. Hiểu đơn giản thì cổng chú ý nguyên bản có vẻ hợp hơn khi hộp giới hạn lý tưởng, còn CAD lại có ích rõ hơn khi câu nhắc bị sai lệch.
...
\noindent\textbf{Sự bổ trợ giữa PSG, CAD và bản đồ nhiệt Gaussian.}
Trong kịch bản Lệch tâm, PSG riêng lẻ cải thiện 0,0181 so với U-Net+Concat, trong khi CAD riêng lẻ giảm 0,0028. Ngược lại, cấu hình đầy đủ PSG+CAD+Gaussian cải thiện 0,1271, từ 0,6579 lên 0,7850. Nhìn vào số này thì CAD không hoạt động hiệu quả như một thành phần độc lập, mà cần đặc trưng đã được PSG điều biến tại bộ mã hóa từ trước.
...
Ở nhóm Tổn thương rõ, khoảng cách Dice thu hẹp còn khoảng 0,068, tức là hai mô hình gần nhau hơn khi vùng tổn thương dễ xác định. Riêng kết quả ở nhóm Biên mờ cần được diễn giải thận trọng vì nhóm được lựa chọn dựa trên Dice thấp của SAM-Med2D.
...
Tăng độ phân giải cải thiện Dice trên cả ba nhóm, nhưng mức tăng lớn nhất xuất hiện ở Tổn thương nhỏ. Dice của nhóm này tăng 0,0444, từ 0,7584 lên 0,8028; Precision tăng 0,0617 và CBL tăng 0,0275. Có thể thấy tổn thương nhỏ hưởng lợi rõ nhất từ việc giữ được nhiều chi tiết không gian hơn ở đầu vào.
...
Khi câu nhắc chỉ được nối vào đầu vào, chênh lệch giữa Gaussian và mặt nạ nhị phân đều nhỏ hơn 0,01 Dice và không nhất quán về chiều giữa hai bộ dữ liệu. Nói cách khác, tự riêng cách biểu diễn câu nhắc thì chưa đủ để tạo khác biệt lớn nếu kiến trúc không có cơ chế khai thác câu nhắc ở nhiều tầng.
...
Nhìn chung, hiệu năng của PGA-UNet tương đối ổn định trước thay đổi cách phân chia dữ liệu. Tuy nhiên, độ lệch chuẩn qua Phân vùng và chênh lệch giữa các cấu hình đo hai nguồn biến động khác nhau, nên không được kết hợp thành một tỷ lệ tín hiệu trên nhiễu.
...
Nếu nhìn trên cả hai bộ dữ liệu thì phần đóng góp nhất quán nhất của PGA-UNet nằm ở khả năng duy trì hiệu năng khi câu nhắc bị sai lệch. Ở kịch bản Lệch tâm, CAD cao hơn cổng chú ý nguyên bản và bản đồ nhiệt Gaussian cao hơn câu nhắc nhị phân với biên độ lớn, cùng giá trị $p<0{,}001$ trên cả BTXRD và FracAtlas. Đây là bằng chứng mạnh nhất cho vai trò phối hợp của PSG, CAD và Gaussian trong thiết kế đề xuất, nhưng cũng chỉ mới nằm trong phạm vi các sai lệch câu nhắc mô phỏng đã được khảo sát.
