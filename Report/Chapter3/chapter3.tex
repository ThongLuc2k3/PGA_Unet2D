...
Các hệ số $w_l$, tham số khởi tạo và cấu hình huấn luyện được lựa chọn trên tập xác thực và giữ cố định khi đánh giá tập kiểm thử. Giá trị cụ thể được trình bày tại Mục~\ref{subsec:models_compared}, Chương~\ref{Chapter4}; đóng góp của từng thành phần được phân tích tại Mục~\ref{subsec:ablation_arch}.
