...
Quy trình suy luận chỉ yêu cầu một lượt truyền xuôi qua mô hình. Với kiến trúc và số kênh cố định, chi phí tính toán tăng theo số điểm ảnh đầu vào. So sánh định lượng về số tham số và chi phí suy luận giữa PGA-UNet với các mô hình khác được trình bày tại Mục~\ref{subsec:efficiency}, Chương~\ref{Chapter4}.
