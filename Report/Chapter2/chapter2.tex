...
Bộ mã hóa thực hiện các phép tích chập và giảm mẫu để tăng dần phạm vi tiếp nhận, qua đó trích xuất đặc trưng từ mức cục bộ đến mức ngữ nghĩa. Khi độ phân giải giảm, số kênh đặc trưng thường tăng để mô hình biểu diễn thông tin phức tạp hơn.
