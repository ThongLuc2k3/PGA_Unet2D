...
Chương này gồm hai phần chính. Phần đầu điểm lại các hướng nghiên cứu có liên quan đến phân đoạn ảnh y khoa, nhất là các mô hình tự động, các phương pháp phân đoạn tương tác dựa trên CNN và các mô hình nền tảng có dùng câu nhắc. Từ phần này, khóa luận rút ra khoảng trống mà khóa luận muốn đi vào. Phần sau trình bày các cơ sở lý thuyết cần dùng như U-Net, cơ chế chú ý, cách biểu diễn câu nhắc trực quan và các chỉ số đánh giá mô hình.
...
U-Net~\cite{ronneberger2015unet} là một trong những kiến trúc quan trọng nhất của phân đoạn ảnh y khoa. Mô hình có dạng mã hóa--giải mã đối xứng và dùng các kết nối tắt để giữ lại thông tin vị trí từ các tầng nông trong lúc vẫn học được đặc trưng ngữ nghĩa ở các tầng sâu. Thiết kế này hợp với dữ liệu y khoa, vốn thường không có quá nhiều ảnh được gán nhãn phân đoạn.
...
Tuy nhiên, ở dạng gốc thì cả U-Net lẫn Attention U-Net đều là các mô hình tự động, nghĩa là chỉ nhận ảnh đầu vào và phải tự tìm vùng cần phân đoạn. Với ảnh X-quang xương, đây là một yêu cầu không hề nhẹ vì tổn thương có thể nhỏ, mờ hoặc nằm trong vùng nhiều cấu trúc chồng lấp. Ngoài ra, người dùng cũng khó can thiệp để hướng mô hình tập trung vào một vùng cụ thể tại thời điểm suy luận.
...
Các phương pháp tương tác ban đầu thường khai thác tín hiệu người dùng ở dạng điểm bấm hoặc nét vẽ. Deep Interactive Object Selection~\cite{xu2016deepinteractive} là một ví dụ sớm cho thấy chỉ với những tương tác đơn giản, nếu mã hóa phù hợp thành bản đồ khoảng cách rồi đưa vào CNN thì chất lượng mặt nạ có thể tăng đáng kể. Trong ảnh y khoa, DeepIGeoS~\cite{wang2019deepigeos} là một ví dụ tiêu biểu. Cách làm của phương pháp này là tạo một phân đoạn ban đầu, sau đó dùng thêm tương tác người dùng để tinh chỉnh lại những vùng còn sai.

Nhìn chung, các phương pháp này cho thấy tương tác của người dùng hoàn toàn có thể đổi thành bản đồ hai chiều và đưa trực tiếp vào CNN. Dù vậy, nếu chỉ ghép bản đồ đó ở đầu vào thì chưa chắc thông tin định hướng còn rõ ở các tầng sâu hơn của mạng. Đây cũng là một lý do để khóa luận đi tiếp theo hướng tích hợp câu nhắc sâu hơn vào quá trình mã hóa và giải mã đặc trưng.
...
Chương này đã điểm qua các phương pháp phân đoạn tự động, phân đoạn tương tác dựa trên CNN và mô hình nền tảng dựa trên câu nhắc. Từ đó, khóa luận thấy rõ hơn khoảng trống nghiên cứu mà mình nhắm tới: nhu cầu về một kiến trúc CNN hạng nhẹ có thể tiếp nhận và giữ thông tin câu nhắc trong suốt quá trình phân đoạn.

Các cơ sở lý thuyết về U-Net, Cổng chú ý, bản đồ nhiệt, điều biến đặc trưng và chú ý có điều kiện là nền để đi đến thiết kế PGA-UNet ở Chương~\ref{Chapter3}. Chương này cũng chốt các độ đo sẽ dùng để đánh giá định lượng mô hình ở Chương~\ref{Chapter4}.
