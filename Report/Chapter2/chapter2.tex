...
% [HÌNH CẦN XUẤT FILE] diagram_unet.png
% Nguồn: diagrams/arch_unet2d.drawio → export PNG → lưu vào Report/images/diagram_unet.png
% \begin{figure}[htbp]
% \centering
...
% [HÌNH CẦN XUẤT FILE] diagram_attunet.png
% Nguồn: diagrams/arch_attention_unet2d.drawio → export PNG → lưu vào Report/images/diagram_attunet.png
% \begin{figure}[htbp]
%     \centering
