...
Hệ số Dice và HD95 đánh giá chất lượng phân đoạn đầu ra, nhưng không phản ánh được độ lệch không gian giữa tâm dự đoán và tâm tổn thương thực tế. Để đánh giá tính chính xác định vị không gian của hệ thống trong các kịch bản câu nhắc bị lệch, khóa luận sử dụng độ đo Độ chuẩn xác định vị tâm (Center-Based Localization - CBL).
...
Bên cạnh đó, các lý thuyết về chuyển đổi hộp giới hạn thành bản đồ nhiệt, Cổng chú ý có điều kiện, là những nền tảng cốt lõi sẽ được tích hợp vào kiến trúc PGA-UNet trình bày ở Chương 3.