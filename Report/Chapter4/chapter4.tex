...
Phần tiền xử lý được áp dụng giống nhau cho cả hai bộ dữ liệu. Thay vì co giãn trực tiếp ảnh gốc về khung vuông đích, khóa luận dùng quy trình \textit{resize + padding}: ảnh X-quang trước hết được thu phóng đồng tỉ lệ sao cho cạnh dài nhất khớp với kích thước đích ($512$ hoặc $256$ điểm ảnh), sau đó được đệm nền để tạo khung vuông $512\times512$ hoặc $256\times256$. Cách này giữ nguyên tỉ lệ hình học của cấu trúc xương và tránh méo ảnh do kéo giãn không đồng đều theo hai trục. Mặt nạ nhị phân được tạo từ tọa độ đa giác trong chú thích và cũng được biến đổi theo đúng quy trình đó, với nội suy lân cận gần nhất để không làm mờ biên phân đoạn. Tương tự, bản đồ nhiệt câu nhắc được chuẩn hóa theo cùng quy trình \textit{resize + padding} để đồng bộ hoàn toàn với ảnh đầu vào. Dữ liệu sau tiền xử lý được dùng thống nhất trong huấn luyện, suy luận và lúc trực quan hóa kết quả.
