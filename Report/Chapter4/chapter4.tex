...
Tiền xử lý được áp dụng thống nhất cho cả hai bộ dữ liệu. Ảnh X-quang được đưa về kích thước $512\times512$ hoặc $256\times256$ bằng cách co giãn theo cùng hệ số để giữ tỷ lệ khung hình gốc, sau đó đệm (\textit{padding}) về khung vuông ở giữa ảnh. Mặt nạ nhị phân được tạo từ tọa độ đa giác trong tệp chú thích và được biến đổi tương ứng bằng cùng quy trình co giãn giữ tỷ lệ kết hợp đệm nền 0. Bản đồ nhiệt câu nhắc cũng được chuẩn hóa theo cùng quy trình để đồng bộ với ảnh đầu vào. Dữ liệu sau tiền xử lý được sử dụng thống nhất trong các giai đoạn huấn luyện, suy luận và hiển thị kết quả.
